...
export default function Home({ featuredProduct, newProducts }) {
  return (
    <BG>
      ...
      <StoreInfo>
        The store is located in the heart of the arts and crafts community, and its primary focus is on creating one-of-a-kind pieces of jewelry. We offer custom engraving in a variety of fonts, and you can select the type of chain you want. Bracelets, necklaces, and even rings are available for everybody!
      </StoreInfo>
      <Line />
      <SourcingInfo>
      ...
      <div style={{ display: "flex" }}>
        <ProductDesc>
          100% RECYCLABLE {"\n"} {"\n"}
          Environmentally neutral means that stainless steel doesn't release any harmful substances or toxins when it comes in contact with water, soil, or air. {"\n"}{"\n"}
          There are also no chemicals used in this process, so there is no chemical waste. {"\n"}{"\n"}
          Even if it's not biodegradable, as long as it doesn't hurt the environment, it's good for the environment. STAINLESS STEEL CONTAINS METALS THAT ARE GOOD FOR THE SOIL. So, if anything, this material has positive effects on the environment.
        </ProductDesc>
        <USPSection>
